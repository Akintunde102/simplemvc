	...
	public function show($fn){
		...
		switch($this->type){
			case IMAGETYPE_GIF:
				...
				imagegif($this->img, "$fn.gif");
				break;
			case IMAGETYPE_PNG:
				header('Content-type: image/png');
				imagepng($this->img, "$fn.png", $this->quality);
				break;
			default:
				header('Content-type: image/jpeg');
				imagejpeg($this->img, "$fn.jpg", $this->quality);
				break;
		}
		
		
	$this->cleanup();
	header("Location: $fn.jpg");
die();
	}
	 ...
	 * @return $this
	 */
	public function draw($file, $x='50%', $y='50%',$h=0,$w=0){
